...
{
    public partial class IRInterface : Form
    {

        private Keithley2700DataSaver dataSaver;
        public IRInterface()
        {
            InitializeComponent();
        ...
        private void Outfile_OutputFilenameChanged(object sender, OutputFileNameChangedEventArgs e)
        {
            string[] header = dataFilter.getDataNames();
            dataSaver = new Keithley2700DataSaver(e.outputDirectory + e.filename, header, DateTime.Now);
        }

        private void DataFilter_FilterReadingsUpdate(object sender, ReadingsUpdateEventArgs e)
        {
            if ( dataSaver != null )
            {
